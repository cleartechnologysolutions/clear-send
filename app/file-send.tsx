      ...
      <div className="mx-auto flex min-h-[calc(100vh-2.5rem)] max-w-7xl flex-col gap-5">
        <header className="flex flex-wrap items-center justify-between gap-4 rounded-lg border border-cyan-300/20 bg-[#0d1a29] px-4 py-3 shadow-2xl shadow-black/20">
          <a href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-cyan-100/80">Clear Send</p>
            </div>
          </a>
          <button
            type="button"
        ...
        <section className="grid flex-1 gap-5 lg:grid-cols-[360px_1fr]">
          <aside className="rounded-lg border border-white/10 bg-white/[.05] p-5 shadow-2xl shadow-black/25">
            <h1 className="text-3xl font-black tracking-tight">Clear Send</h1>
            <p className="mt-3 text-sm leading-6 text-slate-300">
              A simple Clear Technology Solutions file handoff. Upload one file, send the link, and it disappears after 2 downloads or 24 hours.
            </p>
